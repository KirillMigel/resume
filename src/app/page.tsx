      ...
      <div className="mx-auto max-w-6xl px-4 pb-16 pt-8 text-center sm:px-6 sm:pb-20 sm:pt-10">
        ...
        <div className="mt-12 flex flex-col items-center gap-6 sm:mt-16">
          ...
          <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-center">
            <Link
              href="/dashboard"
              className="inline-flex w-full max-w-md items-center justify-center rounded-full bg-[#218DD0] px-6 py-3 text-[16px] font-semibold text-white shadow-[0_5px_20px_rgba(24,145,228,0.35)] transition hover:bg-[#0c74c1] sm:w-auto"
            >
              Создать резюме
            </Link>
          </div>
